...
/*
    Body parser - 
    for any non GET verb which we're going to send via body and not via query string.
    (need to "npm install body-parser" it). 
    API Docs: https://www.npmjs.com/package/body-parser-json
*/

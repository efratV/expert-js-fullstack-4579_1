...
const appRoutes: Routes = [
    { path: "bookStore/home", component: HomeComponent },
    {
        path: "bookStore/account", component: AccountComponent, children: [
            { path: '', redirectTo: '/bookStore/account/register', pathMatch: 'full' },
            { path: '/bookStore/account/login', component: LoginComponent },
            { path: '/bookStore/account/register', component: RegisterComponent },
        ]
    },
